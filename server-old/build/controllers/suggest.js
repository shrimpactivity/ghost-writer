...
const validateRequestParams = (params) => {
    const lengthValid = params.amount > 0 && params.amount < 500;
    const accuracyValid = params.accuracy >= 0 && params.accuracy <= 3;
...
suggestRouter.get(baseURL + "/:id", (request, response) => {
    ...
    console.log("Source found, retrieving suggestion from: ", source.title, "-", source.author);
