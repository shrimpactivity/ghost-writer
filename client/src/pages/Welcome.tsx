      ...
      <CenterHorizontal>
        <div style={{ maxWidth: "700px" }}>
          ...
          <p style={{ fontSize: "0.9rem" }}>
            ...
            Dostoevsky, Austen, Homer, and more - summoned to collaborate on
            your next opus.
          </p>
          <p style={{ fontSize: "0.9rem" }}>
            <span style={{ color: "var(--tertiary)" }}>Content Warning:</span>{" "}
            The original texts from Project Gutenberg have not been modified or
            ...
            context. Viewer discretion is advised.
          </p>
          <CenterHorizontal>
            <h1>How To</h1>
          </CenterHorizontal>
