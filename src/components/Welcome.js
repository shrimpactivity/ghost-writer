...
const Welcome = () => {
  return (
    <div className='welcome'>
      ...
      <p><span style={{color: 'lightcoral'}}>Warning:</span> the selected source is not filtered in any way, and may produce less than polite language.</p>
      <p><a href='https://github.com/shrampi/cowriter' style={{color: "#2e79db"}}>GitHub</a></p> 
    </div>
  )
}
