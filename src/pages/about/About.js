  ...
  return (
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      ...
      <div className="welcome" style={style}>
        ...
        >
          Write with your favorite authors from beyond the grave! Whether it be
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              <AddCircleOutlineIcon fontSize="string" /> button or <em>Tab</em>{' '}
              key
            </li>
            <li>
            ...
            <li>
              ...
              will be downloaded and processed into a new ghost, ready to write
              with you.
            </li>
          </ul>
        </div>
